...
Tracker: `[F25]` in the project backlog. References: `runlog-docs/07-mcp-interface.md` §10.4, [`../runlog-author/SKILL.md`](../runlog-author/SKILL.md), `verifier/internal/verify/`.
