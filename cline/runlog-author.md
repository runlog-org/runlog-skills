...
Three structural prerequisites are NOT yet built. See `skills/runlog-author/DESIGN.md §Status` for the full tracker. Until they ship the skill operates on the manual workarounds in the Setup section.
